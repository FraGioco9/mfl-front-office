...
from scripts.marketplace import mfl_marketplace_snapshot as marketplace
from scripts.marketplace.mfl_marketplace_cadence import PLAYER_LISTINGS_PAGE_SCRIPT
