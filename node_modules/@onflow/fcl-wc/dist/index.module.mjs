...
async function createSessionProposal({
  provider,
  existingPairing,
  network
}) {
...
const makeServicePlugin = (provider, config = {
  projectId: "",
  includeBaseWC: false,
  wallets: [],
  wcRequestHook: null,
 ...
 */
function showWcRequestNotification({
  service,
  user
}) {
...
export { FLOW_METHODS, SERVICE_PLUGIN_NAME, WC_SERVICE_METHOD, createSessionProposal, getProvider, init, initLazy, request };
