...
// Use "1.30.3" if available (from build), otherwise use a default for development
...
export { index$1 as AppUtils, CORE_STRATEGIES, FCL_REDIRECT_URL_PARAM_NAME, FCL_RESPONSE_PARAM_NAME, index as InteractionTemplateUtils, TransactionError, URL, VERSION, index$2 as WalletUtils, buildMessageHandler, createFlowClientCore, discovery, events, execStrategy, getChainId, getCurrentUser, getExecHttpPost, getMutate, getServiceRegistry, initServiceRegistry, isReactNative, normalizePollingResponse, pluginRegistry, query, queryRaw, serialize, serviceEndpoint, setIsReactNative, transaction as tx, verifyUserSignatures };
