...
assert.equal(elements.get("plannerAverageAge").textContent, "Avg 24.0", "Totals row must show average age");
assert.equal(elements.get("plannerAverageOverall").textContent, "Avg 77.5", "Totals row must show average overall");
...
assert.equal(elements.get("plannerAverageAge").textContent, "Avg 23.0", "Removing a player must update average age");
assert.equal(elements.get("plannerAverageOverall").textContent, "Avg 80.0", "Removing a player must update average overall");
