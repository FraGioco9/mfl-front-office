...
assert.equal(metric("plannerBest11OverallSum"),"155","Best 11 sums available players when fewer than eleven are present.");
...
assert.equal(metric("plannerBest11OverallSum"),"80","Removing a player must recompute the top-eleven sum.");
assert.equal(body.children[0].children[2].textContent, "First Player");
