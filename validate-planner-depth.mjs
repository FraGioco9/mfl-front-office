...
assert.ok(css.includes('.plannerFormationPlayerPhoto{') && styles.includes('.plannerFormationPlayerPhoto{') && css.includes('object-fit:contain;object-position:center bottom') && styles.includes('object-fit:contain;object-position:center bottom'), "Fit the portrait inside the token without scaling or cropping.");
