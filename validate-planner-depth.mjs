...
assert.ok([source, generated].every(shell => shell.includes('const flatFourMidfield = midfield && count === 4')
  ...
  && shell.includes('const offset = flatFourMidfield ? 0')), "A four-man midfield must use the exact flat 4-4-2 height and suppress individual CM/CDM/CAM depth offsets in both shells.");
