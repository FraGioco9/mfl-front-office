...
assert.ok([source, generated].every(shell => shell.includes('position === "CF" ? ((linePositions.includes("LW") || linePositions.includes("RW")) ? -4 : -3) : 0;')), "CFs must be pushed up in every formation, with the 4-3-3 (CF) marker still ahead of its wingers.");
