...
assert.ok([css, styles].every(sheet => sheet.includes(".plannerFormationTokenPlus{position:absolute;inset:0;display:block;flex:none;width:45%;height:45%;margin:auto;color:inherit;pointer-events:none;transform:none}")), "All empty pitch plus icons must be absolutely centered, regardless of hover animation or flex layout.");
