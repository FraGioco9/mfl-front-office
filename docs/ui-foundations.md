...
- Intermediate desktop (`1101px–1444px`) topbar geometry must compress Search/Stats within the viewport; shared chrome must never widen the document beyond the viewport.
