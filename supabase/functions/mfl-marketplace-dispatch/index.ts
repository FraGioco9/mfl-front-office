...
const DEFAULT_WORKFLOW = "mfl-marketplace-snapshot.yml";
...
function githubHeaders(token: string) {
  return {
    ...
    "User-Agent": "mfl-front-office-supabase-marketplace-scheduler",
  };
}
...
Deno.serve(async (request: Request) => {
  ...
  const workflow = Deno.env.get("GITHUB_MARKETPLACE_WORKFLOW") || DEFAULT_WORKFLOW;
