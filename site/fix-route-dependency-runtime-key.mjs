...
if (!source.includes(before)) throw new Error("Missing generated route runtime-key escape target.");
source = source.replace(before, after);
await writeFile(path, source, "utf8");
console.log("Corrected generated route dependency runtime-key escaping.");
