...
includes(playerCore, "const PLAYER_HERO_IDENTITY_OVERALL_GAP_PX = 252;", "Player hero media width must preserve the further-left portrait and Club-mark overlap.");
