...
includes(playerCore, "const PLAYER_HERO_IDENTITY_OVERALL_GAP_PX = 272;", "Player hero media width must preserve the left-shifted portrait and Club-mark overlap.");
