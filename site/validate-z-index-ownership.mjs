...
invariant(dropdowns.match(/z-index: var\(--mfl-z-dropdown\);/g)?.length === 4, "Account, Watchlist, Player table action, and date picker dropdowns must share one global dropdown level.");
