...
(() => {
  ...
  function normalizePageName(pageName) {
    ...
    if (page === "my-clubs") return "myclubs";
  ...
  function canonicalRequest(pathname = location.pathname) {
    ...
    if ((pageSegment === "my-clubs" || pageSegment === "myclubs") && segments.length === 1) return requestResult(path, "myclubs", {}, "/my-clubs");
...
window.__mflCoreBuildId = "f346c26995150fab";
