...
(() => {
  ...
  const data = freezeDeep({
    release: {
      version: "1.124.55",
      description: "Load the complete MFL Stats population and align active view hover",
    },
    routes: {
      tableViews: {
        database: { order: ["attributes", "contracts", "stats"], fallback: "attributes" },
        mfl: { order: ["attributes", "stats"], fallback: "attributes" },
        progression: { order: ["current", "all"], fallback: "current" },
        agents: { order: ["attributes", "contracts", "next", "current", "all"], fallback: "attributes" },
        watchlist: { order: ["attributes", "next", "contracts", "current", "all"], fallback: "current" },
        myplayers: { order: ["attributes", "next", "contracts", "current", "all"], fallback: "attributes" },
        club: { order: ["attributes", "contracts", "current", "all"], fallback: "attributes" },
      },
      viewBySlug: {
      ...
      tableInfrastructurePages: ["database", "mfl", "agents", "progression", "watchlist", "myplayers", "club"],
    },
    table: {
      baseColumns: ["player_id", "nationality_flag", "name", "nationality", "age", "positions", "player_seasons"],
      statColumns: ["overall", "pace", "shooting", "passing", "dribbling", "defense", "physical"],
      contractColumns: ["overall", "active_contract_club_name", "active_contract_club_division", "active_contract_revenue_share"],
      viewColumns: {
        attributes: ["player_id", "nationality_flag", "name", "nationality", "age", "positions", "player_seasons", "overall", "pace", "shooting", "passing", "dribbling", "defense", "physical", "wallet_name", "player_link"],
        current: ["player_id", "nationality_flag", "name", "nationality", "age", "positions", "player_seasons", "overall", "pace", "shooting", "passing", "dribbling", "defense", "physical", "wallet_name", "player_link"],
        all: ["player_id", "nationality_flag", "name", "nationality", "age", "positions", "player_seasons", "overall", "pace", "shooting", "passing", "dribbling", "defense", "physical", "wallet_name", "player_link"],
        next: ["player_id", "nationality_flag", "name", "nationality", "age", "positions", "player_seasons", "overall", "pace", "shooting", "passing", "dribbling", "defense", "physical", "wallet_name", "player_link"],
        contracts: ["player_id", "nationality_flag", "name", "nationality", "age", "positions", "player_seasons", "overall", "active_contract_club_name", "active_contract_club_division", "active_contract_revenue_share", "wallet_name", "player_link"],
      },
      joinedAgencyPages: ["myplayers", "agents", "mfl"],
      sortableColumns: ["player_id", "name", "age", "player_seasons", "owned_since", "active_contract_revenue_share", "active_contract_club_division", "overall", "pace", "shooting", "passing", "dribbling", "defense", "physical"],
      columnLabels: {
        player_id: "ID",
        nationality_flag: "",
        wallet_name: "Agent",
