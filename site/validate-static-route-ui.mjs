...
const [indexHtml, bootstrap, staticUi, tableLoading, entry] = await Promise.all([
  read("./index.html"),
  read("./bootstrap.js"),
...
console.log("Direct static route shell, first-paint chrome, skeleton, active-state, footer, and Escape validation passed.");
