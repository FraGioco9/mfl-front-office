...
includes(responsive, "#evaluationPage .evaluationTableShell .evaluationTable {\n    width: 100%;\n    min-width: 580px;\n    max-width: none;\n    table-layout: fixed;", "The season-by-season Evaluation table must retain a readable scrollable width floor on small phones.");
...
includes(responsive, "#evaluationPage .evaluationTableShell .evaluationTable {\n    min-width: 520px;\n  }", "Very small phones must retain the intentional scrollable 520px season-table width floor.");
...
includes(responsive, "--mfl-evaluation-header-row-height: 35.625px;\n    --mfl-evaluation-summary-row-height: 35.625px;\n    --mfl-evaluation-season-row-height: 30px;", "Tablet Evaluation must preserve the desktop 38:38:32 header/summary/season height proportions at the 30px season-row scale.");
includes(responsive, "--mfl-evaluation-header-row-height: 30.875px;\n    --mfl-evaluation-summary-row-height: 30.875px;\n    --mfl-evaluation-season-row-height: 26px;", "Small-phone Evaluation must preserve the desktop 38:38:32 header/summary/season height proportions at the 26px season-row scale.");
includes(responsive, "--mfl-evaluation-header-row-height: 28.5px;\n    --mfl-evaluation-summary-row-height: 28.5px;\n    --mfl-evaluation-season-row-height: 24px;", "Very-small-phone Evaluation must preserve the desktop 38:38:32 header/summary/season height proportions at the 24px season-row scale.");
...
includes(indexHtml, '<th aria-label="Expected Seasons"><span class="evaluationHeaderFull">Expected Seasons</span><span class="evaluationHeaderCompact" aria-hidden="true">EXP SZN</span></th>', "Evaluation Expected Seasons must expose EXP SZN on small screens.");
...
includes(indexHtml, '<th aria-label="Discount Factor"><span class="evaluationHeaderFull">Discount Factor</span><span class="evaluationHeaderCompact" aria-hidden="true">DISC FACT</span></th>', "Evaluation Discount Factor must expose DISC FACT on small screens.");
...
includes(responsive, '#evaluationPage {\n    --mfl-evaluation-header-row-height: 35.625px;\n    --mfl-evaluation-summary-row-height: 35.625px;\n    --mfl-evaluation-season-row-height: 30px;\n  }', "Tablet Evaluation must keep desktop-equivalent vertical proportions.");
includes(responsive, '#evaluationPage {\n    --mfl-evaluation-header-row-height: 30.875px;\n    --mfl-evaluation-summary-row-height: 30.875px;\n    --mfl-evaluation-season-row-height: 26px;\n  }', "Small-phone Evaluation must keep desktop-equivalent vertical proportions.");
includes(responsive, '#evaluationPage {\n    --mfl-evaluation-header-row-height: 28.5px;\n    --mfl-evaluation-summary-row-height: 28.5px;\n    --mfl-evaluation-season-row-height: 24px;\n  }', "Very-small-phone Evaluation must keep desktop-equivalent vertical proportions.");
