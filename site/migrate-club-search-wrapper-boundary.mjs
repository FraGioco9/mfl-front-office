...
if (!source.includes(before)) throw new Error("Could not find the intermediate Club search-wrapper boundary.");
await writeFile(path, source.replace(before, after));
console.log("Club search-wrapper splitter now ends at the stable Club view handler.");
