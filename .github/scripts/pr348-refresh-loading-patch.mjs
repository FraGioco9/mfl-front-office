...
replaceExact(
  ...
  "refresh-aware route loading reuse helper",
);
replaceExact(
  "site/bootstrap-core.js",
  ...
  "setPage loading-owner reuse guard",
);
replaceExact(
  "site/bootstrap-core.js",
...
replaceExact(
  ...
  "shared view click transition loader ownership",
);
...
replaceExact(
  ...
  `  core = replaceRequired(\n    core,\n    \`  void runViewTransition(pageName, viewName, {\n    walletAddress: state.currentAgentWalletAddress,\n    watchlistId: state.currentWatchlistId,\n  }, async () => {\n    await setView(viewName);\n  });\`,\n    \`  const clubTarget = pageName === "club" ? clubRouteTargetFromPath() : null;\n  if (pageName === "club" && !clubTarget?.clubId) return;\n  const clubPath = clubTarget?.clubId\n    ? window.__mflAppConfig?.routes?.clubPath?.(clubTarget.clubId, viewName) || ""\n    : "";\n  void runViewTransition(pageName, viewName, {\n    walletAddress: state.currentAgentWalletAddress,\n    watchlistId: state.currentWatchlistId,\n    ...(clubTarget?.clubId ? {\n      clubId: clubTarget.clubId,\n      path: clubPath,\n    } : {}),\n  }, async () => {\n    await setView(viewName);\n  });\`,\n    "Club shared view transition identity",\n  );`,
  "build normalizer shared Club transition contract",
);
...
replaceExact(
  ...
  "loading ownership validator nested reuse contract",
);
replaceExact(
  "site/validate-loading-ownership.mjs",
  ...
  "loading ownership validator page reuse contract",
);
...
replaceExact(
  ...
  "bootstrap validator setPage loading guard",
);
replaceExact(
  "site/validate-bootstrap-ownership.mjs",
  ...
  "bootstrap validator nested loading guard",
);
replaceExact(
  "site/validate-bootstrap-ownership.mjs",
  ...
  "bootstrap validator refresh ownership helper",
);
...
replaceExact(
  ...
  "generated view transition validator loading lifetime",
);
replaceExact(
  "site/validate-generated-view-transition.mjs",
  ...
  "generated shared view activation marker",
);
replaceExact(
  "site/validate-generated-view-transition.mjs",
  ...
  "generated shared view loader validation",
);
