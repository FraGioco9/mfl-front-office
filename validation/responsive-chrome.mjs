...
export function validateResponsiveChrome(context) {
  ...
  includes(stylesBase, ".advancedMflUsdResetButton[hidden],\n.advancedRewardRateResetButton[hidden],\n.evaluationMetricResetButton[hidden] {\n  display: none;\n}", "Evaluation reset controls must not retain a box when their default values hide them.");
