...
async function installProbeRow(cdp) {
  const evaluation = await cdp.send("Runtime.evaluate", {
    expression: `(() => {
      ...
      page.hidden = false;
      scroller.innerHTML = '<table><tbody id="tableBody"><tr data-player-id="mobile-probe"><td class="nameCell col-name"><div class="playerNameCell"><a class="playerNameLink"><span class="playerNameFullValue">Nicolò Barella</span><span class="playerNameCompactValue">N. Barella</span></a></div></td><td class="col-listing"><span class="listingCellTableHost"><span class="listingCellContent"><span class="listingCellIcon"></span><span class="listingCellPrice">$10,000</span></span></span></td><td class="col-age"><span class="tableControlCellContent"><span class="playerAgeValue">23</span><span class="retirementMarker">R</span></span></td><td class="col-owned-since"><span class="joinedAgencyFullValue">17/09/2026 12:30</span><span class="joinedAgencyCompactValue">17/09/2026</span></td></tr></tbody></table>';
