...
invariant(styles.includes("width:72px") && styles.includes("color:var(--danger)") && styles.includes("border:0;background:transparent"), "Planner Contract must stay compact and roster Remove must be a bare danger-colored X.");
...
invariant(planner.includes("planned_contract_value") && planner.includes("active_contract_revenue_share"), "Planner Contract edits must seed from the current contract value.");
